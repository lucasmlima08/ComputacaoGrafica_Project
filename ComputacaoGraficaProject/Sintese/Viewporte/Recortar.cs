...
namespace ComputacaoGraficaProject.Sintese.Viewporte
{
    public class Recortar
    {
        /* Algoritmo de CohenSutherland. */
        ...
        private bool intersecaoXminA = false;
        private bool intersecaoXmaxA = false;
        private bool intersecaoYminA = false;
        private bool intersecaoYmaxA = false;
        private bool intersecaoXminB = false;
        private bool intersecaoXmaxB = false;
        private bool intersecaoYminB = false;
        private bool intersecaoYmaxB = false;
        ...
        public void recorteA(double X1, double Y1, double X2, double Y2, double Xmin, double Xmax, double Ymin, double Ymax)
        {
            ...
            //RECORTANDO A--------------------------------------
            if (intersecaoYmaxA)
            {//Interseção na Horizontal - YMax A
            ...
            else if (intersecaoYminA)
            {//Interseção na Horizontal - YMin A
            ...
            else if (intersecaoXmaxA)
            {//Interseção na Vertical - XMax A
            ...
            else if (intersecaoXminA)
            {//Interseção na Vertical - Xmin A
        ...
        public void recorteB(double X1, double Y1, double X2, double Y2, double Xmin, double Xmax, double Ymin, double Ymax)
        {
            ...
            //RECORTANDO B -------------------------------------
            if (intersecaoYmaxB)
            {//Interseção na Horizontal - YMax B
                T = (Ymax - valorY1) / (valorY2 - valorY1);
            ...
            else if (intersecaoYminB)
            {//Interseção na Horizontal - YMin B
                T = (Ymin - valorY1) / (valorY2 - valorY1);
                newX2 = valorX1 + (T * (valorX2 - valorX1));
                newY2 = Ymin;
                valorX2 = newX2;
            ...
            else if (intersecaoXmaxB)
            {//Interseção na Vertical - XMax B
                T = (Xmax - valorX1) / (valorX2 - valorX1);
            ...
            else if (intersecaoXminB)
            {//Interseção na Vertical - Xmin B
                T = (Xmin - valorX1) / (valorX2 - valorX1);
                newY2 = valorY1 + (T * (valorY2 - valorY1));
                newX2 = Xmin;
                valorY2 = newY2;
         ...
         * @param Ymax
         */
        public bool checkCandidatoRecorte(double X1, double Y1, double X2, double Y2, double Xmin, double Xmax, double Ymin, double Ymax)
        {
